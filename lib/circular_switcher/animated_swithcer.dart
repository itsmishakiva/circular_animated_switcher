...
/// widget previously set on the [_AnimatedSwitcher] as a child.
///
...
/// with different parameters, then [_AnimatedSwitcher] will *not* do a
...
///  * [FadeTransition], which [_AnimatedSwitcher] uses to perform the transition.
class _AnimatedSwitcher extends StatefulWidget {
  /// Creates an [_AnimatedSwitcher].
  const _AnimatedSwitcher({
    this.child,
    required this.duration,
    this.switchInCurve = Curves.linear,
    this.switchOutCurve = Curves.linear,
    this.transitionBuilder = _AnimatedSwitcher.defaultTransitionBuilder,
  });
  ...
  ///
  /// The default is [_AnimatedSwitcher.defaultTransitionBuilder].
  ///
  ...
  /// return null.
  ///
  /// The default is [_AnimatedSwitcher.defaultLayoutBuilder].
  ///
  /// See also:
  ///
  ...
  final AnimatedSwitcherLayoutBuilder layoutBuilder =
      _AnimatedSwitcher.defaultLayoutBuilder;

  @override
  State<_AnimatedSwitcher> createState() => _AnimatedSwitcherState();
...
class _AnimatedSwitcherState extends State<_AnimatedSwitcher>
  ...
  @override
  void didUpdateWidget(_AnimatedSwitcher oldWidget) {
